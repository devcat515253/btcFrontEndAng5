...
$(function() {
    ...
    $(".share .share__content .ic").on('click', function (e) {
        e.preventDefault();
...
// 	} catch(er) {}
  ...
  $("body").on('click', '.copy-btn', function(e){
    e.preventDefault();
    $(this).closest('.copy').find('.copy-input').select();
    document.execCommand('copy');
    // alert("Скопировано в буфер обмена!");
    return false;
  });

	$("body").on('click', '.hard-table .tr-default', function (e) {
		e.preventDefault();
    ...
    if (_this.hasClass("is-opened")) {
      ...
      var id = _this.find('.transfer-name').text();
      var content = _thisTable.find('td[tr-id="'+ id +'"]').closest('.tr-content');

      var contentText = content.find('.quote').text();
    ...
    // $("body").on('click', '.exchange .column .subblock-content .btns .item', function (e) {
 ...
 //    });
	...
	$("body").on('click', '.js-view-other', function (e) {
		e.preventDefault();
	...
	// $("body").on('click', '.js-select-currencies .item:not(.js-view-other .item)',  function (e) {
	// 	e.preventDefault();
  ...
  $("body").on('click', '.js-deleteBlock', function (e) {
    e.preventDefault();

    var _this = $(this);
    _this.closest(".js-deleteParent").fadeOut();
  });
	...
	$(document).click( function(event){
		if( $(event.target).closest(".dropdown, .transform-to-mobile").length ) // родитель выпадающего списка
		return;
		$(".dropdown").removeClass("_opened");
		event.stopPropagation();
	});

  $("body").on('click', '.js-dropdown-link', function (e) {
    e.preventDefault();
    console.log('js-dropdown-link');
    var _this = $(this);
    var thisContainer = _this.closest(".dropdown");
    $(".dropdown").not(thisContainer).removeClass("_opened");


    if  ( _this.closest(".dropdown").hasClass('_opened') ) {
      _this.closest(".dropdown").removeClass("_opened");
      console.log('js-dropdown-link remove');
    } else {
      _this.closest(".dropdown").addClass("_opened");
      console.log('js-dropdown-link add');
    }


  });

  $("body").on('click', '.dropdown-data li a', function (e) {
    e.preventDefault();
    $(".dropdown").removeClass("_opened");
    $(".transform-to-mobile").toggleClass("sub-opened");
  });

  $(".header .nav-menu > li .dropdown-link").on('click', function (e) {
    e.preventDefault();
    var _this = $(this);
  ...
  function closeDropdownMenu() {
    ...
    if (mediaQuery.matches) {
      $(".header-menu .nav-menu li a:not(.dropdown-link)").on('click', function (e) {
        $(".header-menu .nav-menu .dropdown").removeClass("_opened");
        $(".hamburger").removeClass("is-active");
        $("body").removeClass("menu-mobile__opened");
      });
    }else{

      $(".header .transform-to-mobile .nav-menu li a:not(.dropdown-link)").on('click', function (e) {
        $(".hamburger").removeClass("is-active");
        $("body").removeClass("menu-mobile__opened");
      });
